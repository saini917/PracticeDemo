...
public class SelectCountryAndProceedTestPage extends Base {

	public WebDriver driver;

	@Test(priority = 1)
	public void selectCountryTestPage() throws IOException, InterruptedException {
		...
		SelectCountryAndProceed proceed=PageFactory.initElements(driver,SelectCountryAndProceed.class);
